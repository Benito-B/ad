...
{
	public partial class ListCategoryWindow
	{
		...
		protected virtual void Build()
		{
			...
			// Widget CutreGest.view.windows.ListCategoryWindow
			...
			this.Name = "CutreGest.view.windows.ListCategoryWindow";
			this.Title = global::Mono.Unix.Catalog.GetString("Categorías - Lista");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			this.Decorated = false;
			// Container child CutreGest.view.windows.ListCategoryWindow.Gtk.Container+ContainerChild
			this.vbox1 = new global::Gtk.VBox();
			this.vbox1.Name = "vbox1";
			this.vbox1.Spacing = 6;
			// Container child vbox1.Gtk.Box+BoxChild
			this.UIManager.AddUiFromString(@"<ui><toolbar name='toolbar1'><toolitem name='addAction' action='addAction'/><toolitem name='editAction' action='editAction'/><toolitem name='removeAction' action='removeAction'/><toolitem name='refreshAction' action='refreshAction'/><toolitem name='closeAction1' action='closeAction1'/><toolitem/></toolbar></ui>");
